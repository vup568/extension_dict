...
`REQUIREMENT.md` is authoritative for target product behavior and scope.
`MIGRATION_DECISION.md` is authoritative for how legacy assets are preserved,
...
invariants. `REQUIREMENT.md` remains authoritative for approved product behavior and
scope, and `MIGRATION_DECISION.md` remains authoritative for legacy disposition. When an
