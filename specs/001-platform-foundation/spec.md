...
- [Product Requirements v2](../../docs/REQUIREMENT.md)
- [V2 Migration Decision](../../docs/MIGRATION_DECISION.md)
...
- The current working branch remains `codex/expression-detection` because no Spec Kit branch-creation hook is configured; the feature directory is independently identified by `.specify/feature.json`.
